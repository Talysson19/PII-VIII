...
namespace PII_VIII
{
    public partial class Form1 : Form
    {
        ...
        private async void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                Image = Image.FromFile(@"D:\Usuario\Desktop\PIIVIII\PII VIII\images\\\escolapublica.jpg"),
            ...
            {
                Image = Image.FromFile(@"D:\Usuario\Desktop\PIIVIII\PII VIII\images\\\escolaparticular.png"),
                SizeMode = PictureBoxSizeMode.StretchImage,
                Size = new Size(400, 280),
                Location = new System.Drawing.Point(500, 150),
                BorderStyle = BorderStyle.FixedSingle
        ...
        private void SetupImageSwitcher()
        {
            ...
            escPic.Image = Image.FromFile(@"D:\Usuario\Desktop\PIIVIII\PII VIII\images\\\escolapublica.jpg");
        ...
        private void SwitchImage(object sender, EventArgs e)
        {
            if (isPublicImage)
            {
                escPic.Image = Image.FromFile(@"D:\Usuario\Desktop\PIIVIII\PII VIII\images\\\escolaparticular.png");
            }
            else
            {
                escPic.Image = Image.FromFile(@"D:\Usuario\Desktop\PIIVIII\PII VIII\images\\\escolapublica.jpg");
